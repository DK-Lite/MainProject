...
import numpy as np
import settings
from environment import Envinorment
...
class PolicyLearner:
    ...
    def __init__(self, stock_code, chart_data, training_data=None,
        ...
        self.environment = Envinorment(chart_data) 
        ...
        self.policy_network = PolicyNetwork(
            input_dim = self.num_features, ouput_dim=self.agent.NUM_ACTIONS, lr=lr)
